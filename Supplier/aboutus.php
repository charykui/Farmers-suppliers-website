...
<head>
  ...
  <title>About Us - Greenland Farmers Assistant</title>
    ...
    <div class="matter">
      <div class="container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li class="active"><a href="#">About US</a> <span class="divider">/</span></li>
        </ul>        
                              ...
                              <div class="staff">
                                 ...
                                 <div class="details">
                                    ...
                                    <div class="desig pull-left">
                                       <p class="name">Charity Chepkirui</p>
                                       <em>CEO of Greenland</em>
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                    <!-- Description -->
                                    <p class="adesc"> Incharge of all operations carried out  by farmers and suppliers</p>
                                 </div>
                              </div>
                           </div>
                           <div class="span3">
                              ...
                              <div class="staff">
                                 ...
                                 <div class="details">
                                    <div class="desig pull-left">
                                       <p class="name">Santhosh Pavel</p>
                                       <em>CTO of Greenland</em>
                                    </div>
                                    <div class="asocial pull-right">
                                       <a href="#"><i class="icon-facebook"></i></a>
                                       <a href="#"><i class="icon-twitter"></i></a>
                                    ...
                                    <div class="clearfix"></div>
                                    <p class="adesc">charge of all operations carried out  by farmers and suppliers </p>
                                 </div>
                              </div>
                           </div>
                           <div class="span3">
