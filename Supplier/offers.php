...
<head>
  ...
  <title>Post Offers- Greenland Farmers Assistant</title>
            ...
            <div class="row-fluid">
              <div class="span6">
                ...
                <div class="box-body">
                  <h6>About US</h6>
                  <hr />
                 <p><img src="../img/charity.jpg" alt="" width="150" class="alignleft"/>A Website to help farmers ensure greater profitability through 
         direct farmer to supplier and farmer to farmer communication.
      ...
      <div class="container-fluid">
        ...
        <div class="box-body">
          <div class="row-fluid">
            ...
            <div class="span8">
              <div class="well">
              <form action="OffersExec.php" method="post">
                <h6>Post Offers</h6>
                <hr />
                <input type="text" class="span11" placeholder="Enter type of offer" name="offer_type">
                <br />
                <input type="text" class="span11" placeholder="Enter name" name="offers_name">
                <br />
                <input type="text" class="span11" placeholder="Enter quantity" name="quantity">
                <br />
                
                <button class="btn"><i class="icon-paper-clip"></i> Add Media</button>
                <hr />
                <textarea class="span11" rows="3" name="description" placeholder="description of your offer"></textarea>

                <hr />
                 <div class="form-actions">
                                             <!-- Buttons -->
                    <input type="submit" class="btn-success" value="Submit" name="submit"></button>
  ...
  <!-- Foot starts -->             
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="copy">Copyright 2012 &copy; Greenland Farmers Assistant</div>
      </div>
    </div>
