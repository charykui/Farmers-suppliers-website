        ...
        <div class="s-content">
          ...
          <ul id="nav">
           ...
           <li><a href="index.php" class="open br-red"><i class="icon-home"></i> Home</a>
            ...
            <li class="has_sub"><a href="#" class="br-blue"><i class="icon-list-alt"></i> Suppliers Pages <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
              <ul>
                <li><a href="profile.php">Profile</a></li>
                <li><a href="offers.php">Post Orders</a></li>
                <li><a href="recieveOffers.php">Recieve Orders</a></li>
              </ul>
            </li>  
            ...
            <div class="row-fluid">
              <div class="span6">
                ...
                <div class="box-body">
                  <h6>About Us</h6>
                  <hr />
                  <p><img src="../img/charity.jpg" alt="" width="150" class="alignleft"/>Greenland Farmers Assistant (GFA) is a web service
				          developed to help farmers ensure greater profitability through direct farmer to supplier and farmer to farmer communication.
				          This service boosts business communication and brings transparency in the system. This innovative site allows for good farmer,
				          retailer and supplier communication. Farmer can be able to share new
				           ideas or discoveries with other farmers through their forum page and other pages. </p>
                ...
                <div class="social">
                 ...
                 <div class="address">
                    <div class="row-fluid">
                       ...
                       <div class="span6">
                          <address>
                            <i class="icon-user"></i> <span class="bold">Charity</span><br>
                            <i class="icon-envelope-alt"></i> <a href="mailto:#">charycha@gmail.com</a><br>
    ...
    <div class="matter">
      <div class="container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li class="active"><a href="#">Profile</a> <span class="divider">/</span></li>
        </ul>        
        ...
        <div class="well">
          ...
          <div class="address">
            <address>
              ...
              <!-- Phone number -->
              <abbr title="Phone">P:</abbr> +2547 117552270.<br />
              <a href="mailto:#">charycharice@gmail.com</a>
            </address>
          </div>
        </div>
                            ...
                            <div class="form">
                                      ...
                                      <form class="form-horizontal">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input type="text" class="input-large" id="first-name">
                                            </div>
                                          </div> 
										  <!--  Last Name -->
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input type="text" class="input-large" id="last-name">
                                            </div>
                                          </div>
										  <!-- User Name -->
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input type="text" class="input-large" id="user-name">
                                            </div>
                                          </div>
                                          <!-- Email -->
                                          <div class="control-group">
                                            <label class="control-label" for="email">Email:</label>
                                            <div class="controls">
                                              <input type="text" class="input-large" id="email" placeholder="email@mail.com">
                                            </div>
                                          </div>
										  <!-- Phone number -->
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input type="text" class="input-large" id="telNo">
                                            </div>
                                          </div>
                                          <!-- Select box -->
                                          <div class="control-group">
                                          ...
                                          <div class="form-actions">
                                             <!-- Buttons -->
                                            <input type="submit" class="btn-success" value="Update" name="update"></button>
                                            <input type="reset" class="btn-success"value="Reset" name="reset"></button>
                                          </div>
                                      </form>
                                    </div> 
                                  </div>
            ...
            <div class="row-fluid">
              <div class="span6">
                ...
                <div class="box-body">
                  <h6>About US</h6>
                  <hr />
                  <p><img src="img/charity.jpg" alt="" width="150" class="alignleft"/>Welcome to Greenland Farmers Assistant.Farmer Choice,Farmer Happiness</p>
                  <div class="clearfix"></div>
                 <hr />
      ...
      <div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="copy">Copyright 2012 &copy; - <a href="#">Your Site</a> - Designed by <a href="http://responsivewebinc.com/bootstrap-themes">Bootstrap Themes</a></div>
			</div>
		</div>
