    ...
    <div class="matter">
      ...
      <div class="span4">
        ...
        <div class="well">
          ...
          <div class="address">
            <address>
              <h6><? php  $_SESSION['SESS_username'] = $r['username'];?></h6>
              <h6><? php  $_SESSION['SESS_firstname'] = $r['firstname'];?></h6>
              <h6><? php  $_SESSION['SESS_lastname'] = $r['lastname'];?></h6>
              <!-- Address -->
              <? php $_SESSION['SESS_address'] = $r['address'];?></br>
                <? php $_SESSION['SESS_position'] = $r['position'];?></br>
