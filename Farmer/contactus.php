...
<head>
  ...
  <title>Contact Us - Greenland Farmers Assistant</title>
    ...
    <div class="matter">
      <div class="container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li class ="active"><a href="contactus.php">Contact-us</a> <span class="divider">/</span></li>
        </ul>        
              ...
              <div class="row-fluid">
                           <div class="span12">
                              ...
                              <div class="gmap">
                                 ...
                                 <script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:400px;width:520px;'><div id='gmap_canvas' style='height:400px;width:520px;'></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div> <a href='http://www.maps-generator.com/'>Maps-Generator.com</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=e2156ee5ea9fd9f2699ee2d194165076fa510243'> </script><script type='text/javascript'>function init_map(){var myOptions = {zoom:11,center:new google.maps.LatLng(0.5420664,35.28369780000003),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(0.5420664,35.28369780000003)});infowindow = new google.maps.InfoWindow({content:'<strong>Greenland Farmers</strong><br>Eldoret<br>30100 Eldoret<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
                              </div>
                                 ...
                                 <div class="well">
                                    <!-- Address section -->
                                       ...
                                       <div class="address">
                                           <address>
                                              <!-- Company name -->
                                              <h6>Greenland Farmers Assistant, Inc.</h6>
                                              <!-- Address -->
                                              Moi Avenue Street,Farmers plaza,2ND Floor<br>
                                              Eldoret, Kenya.<br>
                                              <!-- Phone number -->
                                              <abbr title="Phone">P:</abbr> +2547 11752270
                                           </address>
                                            
                                           <address>
                                              <!-- Name -->
                                              <h6>Charity Chepkirui</h6>
                                              <!-- Email -->
                                              <a href="mailto:#">charycharice@gmail@gmail.com</a>
                                           </address>
