...
<head>
  ...
  <title>News Page - Greenland Farmers Assistant </title>
    ...
    <div class="matter">
      <div class="container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li lass="active"><a href="#">News Page</a> <span class="divider">/</span></li>
        </ul>        
                        ...
                        <div class="span8">
                           <div class="posts">
                              ...
                              <div class="entry">
                                 ...
                                 <!-- Meta details -->
                                 <div class="meta">
                                    <i class="icon-calendar"></i> 26-2-2012 <i class="icon-user"></i> Admin <i class="icon-folder-open"></i> <a href="#">General</a> <span class="pull-right"></span>
                                 </div>
                        ...
                        <div class="span4">
                           ...
                           <div class="blog-sidebar">
                              ...
                              <div class="widget">
                                 <h4>Recent Posts</h4>
                                 <ul>
                                 <li>Takes the short description of the news </li>
                                 <li>Takes the short description of the news</li>
                                 <li>Takes the short description of the news</li>
                                 <li>Takes the short description of the news</li>
                                 <li>Takes the short description of the news</li>
